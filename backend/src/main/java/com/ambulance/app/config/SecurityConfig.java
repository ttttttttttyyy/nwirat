    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/requests", "/api/requests/**").hasAnyAuthority("ROLE_AGENT", "ROLE_ADMIN")
                ...
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/authorizations", "/api/authorizations/**").hasAnyAuthority("ROLE_AGENT", "ROLE_ADMIN")
                ...
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/administrative-attestations", "/api/administrative-attestations/**").hasAnyAuthority("ROLE_AGENT", "ROLE_ADMIN")
                ...
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/civil-status", "/api/civil-status/**").hasAnyAuthority("ROLE_AGENT", "ROLE_ADMIN")
